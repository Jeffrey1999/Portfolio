...
//         <h1 class="text-gray-900 text-4xl sm:text-5xl md:text-6xl font-bold mb-4 md:mb-2"> <span className='bg-teal-800 text-gray-100 pl-9'>Je</span>ffrey <br />Asamoah</h1>
//         <div>
...
//           Hi, <Typed className='text-gray-800 '
...
//        <button class="bg-teal-800 hover:bg-gray-800 text-white font-meduim py-1.5 px-5 rounded-md shadow mt-4"> Download CV</button></a>
// </div>
...
//         <div class="bg-gray-100 rounded-lg shadow-lg  relative top-12 md:top-16 left-12 md:left-16 -ml-12 lg:ml-0">
//         {/* <div class="bg-gray-100 rounded-lg shadow-lg overflow-hidden relative top-12 md:top-16 left-12 md:left-16 -ml-12 lg:ml-0"> */}
         
//           <img src={image1} loading="lazy" alt="Software Development Training" class="w-full h-full object-cover object-center border-l-8  border-teal-800 rounded-lg" />
//         </div>

//         <div class="bg-gray-100 rounded-lg shadow-lg overflow-hidden">
          
//           <img src={image2} loading="lazy" alt="Software Development Training" class="w-full h-full object-cover object-center" />
//         </div>
//       </div>
//     </div>
...
<div class="w-full lg:w-1/3 flex flex-col justify-center lg:pt-48 lg:pb-24 mb-6 sm:mb-12 lg:mb-0">
{/* <h1 class="text-gray-900 text-4xl sm:text-5xl md:text-6xl font-bold mb-4 md:mb-2">Jeffrey <br />Asamoah</h1> */}
<h1 class="text-gray-900 text-4xl sm:text-5xl md:text-9xl font-bold mb-4 md:mb-2"> <span className='bg-teal-800 text-gray-100 pl-9'>Je</span>ffrey <br />Asamoah</h1>
<div>
