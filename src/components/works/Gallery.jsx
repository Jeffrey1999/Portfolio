  ...
  return (
    ...
    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
      ...
      <div class="mb-10 md:mb-16">
        <h2 class="text-gray-800 text-2xl lg:text-3xl font-bold text-center mb-4 md:mb-6">Proj<span className='bg-teal-800 text-gray-100  pr-9 hover:bg-gray-800'>ects</span></h2>
      ...
      <a  class="p-5 cursor-pointer flex justify-center items-center hover:bg-gray-100 active:bg-gray-200 text-gray-500 transition duration-100" onClick={()=> setItems(GalleryMenu)}>Everything</a>
...
return(
  ...
  <a href="#" class="group h-30 md:h-96 flex justify-end items-end bg-gray-100 overflow-hidden rounded-lg shadow-lg relative"key={id}>
  <img src={image} loading="lazy" alt="Photo by Minh Pham" class="w-full h-full object-cover object-center absolute inset-0 group-hover:scale-110 transition duration-200" />
